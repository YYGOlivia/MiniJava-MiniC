...
public class MiniJavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CrochFer", "Point", "PtInterro", "DeuxPoint", "Virg", "PtVirg", "Afficher", 
			"Si", "Sinon", "TantQue", "Pour", "Retour", "Final", "DefClasse", "Nouveau", 
			"Ceci", "Asterisque", "Oblique", "PourCent", "Plus", "Moins", "Ou", "Et", 
			"PointExclamation", "Inf", "Sup", "InfEg", "SupEg", "DoubleEgal", "Different", 
			"TypeEntier", "TypeFlottant", "TypeBooleen", "TypeCaractere", "TypeChaine", 
			"TypeVide", "Vrai", "Faux", "Nul", "Caractere", "Chaine", "Publique", 
			"Abstrait", "Prive", "Statique", "Protege", "Etend", "Identificateur", 
